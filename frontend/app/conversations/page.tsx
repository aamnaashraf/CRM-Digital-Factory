      ...
      <div className="relative z-10 p-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="mb-6">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50"
                  />
                </div>
              </div>
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-semibold text-slate-200 text-sm">{conversation.customer}</p>
                            <p className="text-xs text-slate-500">{conversation.customerEmail}</p>
                          </div>
                        </div>
          ...
          <div className="lg:w-2/3">
            {selectedConversation ? (
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700 h-[calc(100vh-120px)] flex flex-col">
                {/* Conversation Header */}
                <div className="p-6 border-b border-slate-700">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-xl font-bold text-slate-200">{selectedConversation.customer}</h2>
                      <p className="text-slate-500">{selectedConversation.customerEmail}</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium capitalize ${getStatusColor(selectedConversation.status)}`}>
                        {selectedConversation.status}
                      </span>
                      <span className="text-sm text-slate-500 capitalize">{selectedConversation.channel}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border-t border-slate-700 bg-slate-800/30">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      disabled
                      className="flex-1 px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50"
                    />
                    <button
                      disabled
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700 h-[calc(100vh-120px)] flex items-center justify-center">
