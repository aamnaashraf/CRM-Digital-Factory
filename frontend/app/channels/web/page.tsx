  ...
  useEffect(() => {
    const fetchRecentTickets = async () => {
      try {
        ...
        const webTickets = activities.filter((ticket: any) => ticket.channel === 'web');
        setRecentTickets(webTickets.slice(0, 5));
        setLoading(false);
      } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 backdrop-blur-sm">
            <div className="p-2 rounded-full bg-purple-500/30">
              <Globe className="w-5 h-5 text-purple-400" />
            </div>
            <span className="text-purple-400 text-sm font-medium">Web Form Integration</span>
          </div>

          <h1 className="text-5xl font-bold bg-gradient-to-r from-purple-400 via-blue-500 to-cyan-500 bg-clip-text text-transparent mb-6">
            Web Form Channel
          </h1>

          <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Real-time web form submissions with AI-powered responses
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 relative overflow-hidden">
            ...
            <div className="absolute -bottom-20 -left-20 w-32 h-32 rounded-full bg-blue-500/10 group-hover:scale-150 group-hover:opacity-20 transition-all duration-1000"></div>
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-slate-200">
                ...
                <span>How to Test Web Form Channel</span>
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-4 relative z-10">
              <div className="p-4 bg-slate-700/50 rounded-xl border border-slate-600">
                ...
                <p className="text-slate-400 text-sm">
                  Submit a form on your website that connects to our support system
                </p>
                <p className="text-slate-500 text-xs mt-2">
                  Use the form at <Link href="/support" className="text-purple-400 hover:underline">/support</Link> for testing
                </p>
              </div>
              ...
              <div className="p-4 bg-slate-700/50 rounded-xl border border-slate-600">
                ...
                <ul className="text-slate-400 text-sm mt-2 space-y-1 ml-4">
                  <li className="flex items-start gap-2">
                    ...
                    Create a ticket with channel="web"
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-3 h-3 text-green-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="p-4 bg-slate-700/50 rounded-xl border border-slate-600">
                ...
                <p className="text-slate-400 text-sm">
                  This channel uses direct API integration - no manual form submission required.
                  Customers submit forms directly through your website interface.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 relative overflow-hidden">
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-slate-200">
                ...
                <span>Recent Web Form Activity</span>
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-4 relative z-10">
              {loading ? (
                ...
                <div className="text-center py-8 text-slate-400">
                  ...
                  <p>No recent web form activity</p>
                  <p className="text-sm mt-2">Submit a form to test the integration!</p>
                </div>
              ) : (
        ...
        <div className="mt-12 text-center mb-12">
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500/30 backdrop-blur-sm">
            <CheckCircle className="w-4 h-4 text-green-400" />
            <span className="text-slate-300 text-sm">
              AI-powered web form processing with no manual intervention
            </span>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto pt-12 border-t border-slate-700">
          <div className="text-center">
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 rounded-full bg-gradient-to-r from-slate-800 to-slate-900 border border-slate-600 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300">
              ...
              <span className="text-slate-200 text-lg font-semibold hover:text-cyan-400 transition-colors">Web Form Integration</span>
            </div>

            <p className="text-slate-400 text-sm max-w-2xl mx-auto mb-8 hover:text-slate-300 transition-colors">
              Secure and automated web form processing with instant customer support. Real-time responses through your website interface.
            </p>

            <div className="flex flex-wrap justify-center gap-8 text-xs text-slate-500 mb-8">
              <span className="hover:text-cyan-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-cyan-400/50 pb-1">Form Processing</span>
              <span className="hover:text-blue-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-blue-400/50 pb-1">API Integration</span>
              <span className="hover:text-purple-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-purple-400/50 pb-1">AI Automation</span>
              <span className="hover:text-emerald-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-emerald-400/50 pb-1">Webhook Sync</span>
              <span className="hover:text-amber-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-amber-400/50 pb-1">Real-time Response</span>
            </div>

            <div className="border-t border-slate-700 pt-8">
              <p className="text-slate-500 text-sm hover:text-slate-400 transition-colors">
                © 2026 TaskFlow AI Web Form Integration. Built for the CRM Digital FTE Factory Final Hackathon 5.
              </p>
              <p className="text-slate-600 text-xs mt-2 hover:text-slate-500 transition-colors">
                Secure form processing with intelligent AI responses.
              </p>
            </div>
          </div>
        </div>
