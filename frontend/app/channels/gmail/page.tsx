...
export default function GmailChannelPage() {
  ...
  useEffect(() => {
    const fetchRecentTickets = async () => {
      try {
        ...
        const gmailTickets = activities.filter((ticket: any) => ticket.channel === 'email');
        setRecentTickets(gmailTickets.slice(0, 5));
        setLoading(false);
      } catch (err) {
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 backdrop-blur-sm">
            ...
            <span className="text-blue-400 text-sm font-medium">Gmail Integration</span>
          </div>
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Webhook-based email processing with AI-powered responses
          </p>
        </div>
          ...
          <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 relative overflow-hidden">
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-slate-200">
                ...
                <span>How to Test Gmail Channel</span>
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-4 relative z-10">
              <div className="p-4 bg-slate-700/50 rounded-xl border border-slate-600">
                ...
                <p className="text-slate-400 text-sm">
                  Send an email to: <span className="font-mono bg-slate-800 px-2 py-1 rounded text-amber-400">aamnaashraf501@gmail.com</span>
                </p>
                <p className="text-slate-500 text-xs mt-2">
                  Include your query in the email body
                </p>
              </div>
              ...
              <div className="p-4 bg-slate-700/50 rounded-xl border border-slate-600">
                ...
                <ul className="text-slate-400 text-sm mt-2 space-y-1 ml-4">
                  <li className="flex items-start gap-2">
                    ...
                    Create a ticket with channel="email"
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-3 h-3 text-green-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="p-4 bg-slate-700/50 rounded-xl border border-slate-600">
                ...
                <p className="text-slate-400 text-sm">
                  This channel uses inbound webhook/polling - no manual form submission required.
                  Customers send emails directly to our support address.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:shadow-2xl hover:scale-[1.01] transition-all duration-300 relative overflow-hidden">
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-slate-200">
                ...
                <span>Recent Gmail Activity</span>
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-4 relative z-10">
              {loading ? (
                ...
                <div className="text-center py-8 text-slate-400">
                  ...
                  <p className="text-sm mt-2">Send an email to test the integration!</p>
                </div>
              ) : (
        ...
        <div className="mt-12 text-center mb-12">
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 backdrop-blur-sm">
            <CheckCircle className="w-4 h-4 text-green-400" />
            <span className="text-slate-300 text-sm">
              AI-powered email processing with no manual intervention
            </span>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto pt-12 border-t border-slate-700">
          <div className="text-center">
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 rounded-full bg-gradient-to-r from-slate-800 to-slate-900 border border-slate-600 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300">
              ...
              <span className="text-slate-200 text-lg font-semibold hover:text-cyan-400 transition-colors">Gmail Integration</span>
            </div>

            <p className="text-slate-400 text-sm max-w-2xl mx-auto mb-8 hover:text-slate-300 transition-colors">
              Secure and automated email processing through Gmail API. Real-time customer support via email.
            </p>

            <div className="flex flex-wrap justify-center gap-8 text-xs text-slate-500 mb-8">
              <span className="hover:text-cyan-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-cyan-400/50 pb-1">Email Processing</span>
              <span className="hover:text-blue-400 hover:scale-110 transition-all duration-300 cursor-pointer border-b border-transparent hover:border-blue-400/50 pb-1">Gmail API</span>
            ...
            <div className="border-t border-slate-700 pt-8">
              <p className="text-slate-500 text-sm hover:text-slate-400 transition-colors">
                © 2026 TaskFlow AI Gmail Integration. Built for the CRM Digital FTE Factory Final Hackathon 5.
              </p>
              <p className="text-slate-600 text-xs mt-2 hover:text-slate-500 transition-colors">
                Secure email processing with intelligent AI responses.
              </p>
            </div>
          </div>
        </div>
